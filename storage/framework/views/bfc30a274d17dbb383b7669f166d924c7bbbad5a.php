...
<?php $__env->startSection('content'); ?>
  <!-- Main -->
            ...
            <div class="col-sm-4 col-xs-8 text-center text-xs-left">
              <select  style="border:none;cursor: pointer;font-size: 16px;margin: 5px 0">
                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($c->id); ?>" <?php echo e(($c->id == $course->id) ? 'selected' : ''); ?>><?php echo e($c->title); ?></option>
    ...
    <script>
      ...
      $.getJSON("<?php echo e(url('contributor/bootcamp/course/get/'.$course->id)); ?>", function (data) {
        var json = data;
        function sideBarRefresh(){
          ...
          $("#items").on( "sortupdate", function(e, ui) {
            $.ajax({
              type    : 'POST',
              url     : '<?php echo e(url("contributor/bootcamp/course/section-save-position")); ?>',
 ...
 // 6c9287927c585fe101ad0da9af65d125da270059
                            ...
                            <div class="col-xs-12 p-4">
                              <form>
                                ...
                                <div class="text-right">
                                  ...
                                  <button type="button" class="btn btn-green px-5 mr-2" onClick="addLesson(<?php echo e($course->id); ?>)">Simpan</button>
                                  <div class="dropup">
      ...
      function createVideo(id){
        ...
        $('#drop-area').dmUploader({ //
          url: '<?php echo e(url("contributor/bootcamp/course/video-create-temp")); ?>',
          maxFileSize: (1024 * 1024) * 100, // 100 MB 
          multiple: false,
          allowedTypes: 'video/*',
          extFilter: ['mp4'],
          extraData: {
            bootcamp_id: '<?php echo e($course->bootcamp_id); ?>',
      ...
      function addLesson(){
        ...
        dataform.append('course_id', '<?php echo e($course->id); ?>');
        ...
        if (judul == '' || desk == '') {
          ...
          $.ajax({
              type    :"POST",
              url     :'<?php echo e(url("contributor/bootcamp/course/section-create")); ?>',
              data    : dataform,
              dataType : 'json',
              contentType: false,
              processData: false,
      ...
      function addProject(id) {
        ...
        if (judul == '' || desk == '' || type == '' || value == '') {
          ...
          $.ajax({
              type    :"POST",
              url     :'<?php echo e(url("contributor/bootcamp/course/project-create")); ?>',
              data    : dataform,
              dataType : 'json',
              contentType: false,
              processData: false,
      ...
      function addVideo(id) {
        ...
        if (judul == '' || desk == '' || type == '') {
          ...
          $.ajax({
              type    :"POST",
              url     :'<?php echo e(url("contributor/bootcamp/course/video-create")); ?>',
              data    : dataform,
              dataType : 'json',
              contentType: false,
              processData: false,
