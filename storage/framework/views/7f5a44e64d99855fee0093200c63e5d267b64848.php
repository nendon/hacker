...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/timelines-vertical.css')); ?>">
    ...
    <link href="<?php echo e(asset('template/web/css/video-js.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('template/web/css/navbar.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('template/web/css/pace.css')); ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/star-rating.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/imageviewer.css')); ?>" />
    <!-- rating -->
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/owl.theme.default.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/owl.theme.green.min.css')); ?>">
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('template/kontributor/img/logo-only.png')); ?>"/>
    <link rel="stylesheet" href="<?php echo e(asset('template/web/plugins/ionicons-2.0.1/css/ionicons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/web/plugins/OwlCarousel2-2.2.1/dist/assets/owl.carousel.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('template/web/plugins/jquery-ui-1.12.1.custom/jquery-ui.css')); ?>">
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/jquery.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/jquery-ui.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/venobox.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/imageviewer.min.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('template/web/plugins/OwlCarousel2-2.2.1/dist/owl.carousel.js')); ?>"></script>
    <!-- Facebook Pixel Code -->
    <script>
...
.ui-autocomplete.opened {
  opacity: 1;
    ...
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/helper.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/common.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/web/css/blocks.css')); ?>">
    ...
    <!--<div class="loading">
        ...
        <div class="middle">
            <div class="middle-item">
                <img src="<?php echo e(asset('template/web/img/logo.png')); ?>" alt="cilsy" class="logo">
            </div>
        </div>
    </div>-->
    <!-- Navbar -->
    ...
    <?php } ?>
      <div class="container">
          ...
          <div id="box">
            <?php if(Auth::guard("members")->user()): ?>
              <div id="items" style="top:38%">
                  ...
                  <a href="<?php echo e(url('member/dashboard')); ?>" ><div class="item">Tutorial Saya</div></a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <form class="navbar-form navbar-left form-search hidden-xs" action="<?php echo e(url('search')); ?>" method="get">
          ...
          <div class="header-menu">
                <ul>
                    <li>
                      <a href="<?php echo e(url('member/dashboard')); ?>" class="hello-user" style=".hello-user:hover{ text-decoration:none;}">
                        Tutorial Saya
                      </a>
                    </li>
                    <li class="class">
                        <a  href="#" id="cart"><img class="icon" src="<?php echo e(asset('template/web/img/CART.png')); ?>" alt="cart">
                        <?php if(getTotalCart() != null){ ?>
                    ...
                    <li class="has-dropdown">
                        <img class="icon" src="<?php echo e(asset('template/kontributor/img/icon/Notifikasi.png')); ?>" alt="">
                        ...
                        <div class="dropdown-container">
                            <ul>
                              ...
                              <li><a href="<?php echo e(url('/user/notif')); ?>">Lihat Semua Pemberitahuan</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="has-dropdown">
                        <img class="icon" src="<?php echo e(asset('template/web/img/drop-down-round-button.png')); ?>" alt="">
                        <div class="dropdown-container" style="right: 0px;">
                            <ul>
                                <li>
                                  
                                    <a href="<?php echo e(url('member/profile/'.Helper::member('username'))); ?>">
                                      <?php if(Helper::member('avatar') != null): ?>
                                      <img src="<?=Helper::member('avatar');?>" class="poto img-circle" alt="" style="">
                                      <?php else: ?>
                                      <img src="<?php echo e(asset(profil())); ?>" class="poto img-circle" alt="" style="">
                                      <?php endif; ?>
                                      <?php if(Helper::member('full_name') != null): ?>
                                ...
                                <hr>
                                <li>
                                    <a href="<?php echo e(url('member/profile/edit')); ?>">
                                        Pengaturan Akun
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('member/riwayat')); ?>">
                                        Riwayat Pembelian
                                    </a>
                                </li>
                                <hr>
                                <li>
                                    <a id="logout" href="<?php echo e(url('member/signout')); ?>" style="font-color:#2BA8E2;">
                                        Logout
                                    </a>
                                </li>
                            </ul>
          ...
          <div class="shopping-cart" style="display: none;">
            <ul class="shopping-cart-items">
              ...
              <li style="text-align:center; color:#2BA8E2;"><a href="<?php echo e(url('/cart')); ?>" > See all ( <?php echo getTotalCart();?> )</a></li>
              <?php } ?>
            </ul>
            
            <a href="<?php echo e(url('/cart')); ?>" class="button">Lihat Keranjang</a>
          </div>
          <?php else: ?>
          <div class="header-menu">
            <ul class="navbar-nav navbar-right">
                <li class="class">
                  <a href="<?php echo e(url('/cart')); ?>" ><img class="icon" src="<?php echo e(asset('template/web/img/CART.png')); ?>"  alt="cart">
                    <span class="badge-cart hide"></span>
                  </a>                   
                </li>
                <li><a href="<?php echo e(url('member/signin')); ?>">Masuk</a></li>
                <li><a href="<?php echo e(url('member/signup')); ?>">Daftar</a></li>
            </ul>
           </div>
          <?php endif; ?>
        </div><!-- /.navbar-collapse -->
        ...
        <div class="collapse navbar-collapse hidden-sm hidden-md hidden-lg" id="bs-example-navbar-collapse-search" style="overflow-y: visible;">
          <form class="navbar-form navbar-left form-search " action="<?php echo e(url('search')); ?>" method="get">
            <input type="hidden" name="category" value="" class="searchcategory">
    ...
    <div id="header" class="hidden">
        <div class="container">
            ...
            <div class="header-left pull-right">
                ...
                <div class="drop-down">
                  ...
                  <div class="drop-down-content">
                    <table cellpadding="15">
                      <tr>
                        <td><a href="<?php echo e(url('member/profile')); ?>" class="btn btn-success">Profil</a></td>
                        <td><a href="<?php echo e(url('member/signout')); ?>" class="btn btn-primary btn-signout">Logout</a></td>
                      </tr>
                    </table>
                  </div>
                </div>
              ...
              <?php } else {?>
                <a href="<?php echo e(url('member/signin')); ?>" class="masuk-btn">Masuk</a>
                <a href="<?php echo e(url('member/signup')); ?>" class="daftar-header-btn">Daftar</a>
              <?php }?>
            </div>
        </div>
    </div>
    <div class="main-wrapper">
      <?php echo $__env->yieldContent('content'); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <img class="footer-logo" src="<?php echo e(asset('template/web/img/logo-only.png')); ?>" alt=""></img>
                ...
                <div class="col-md-2">
                    <ul class="nav-footer">
                        ...
                        <li><a href="<?php echo e(url('/carapesan')); ?>">Cara Pesan</a></li>
                        <li><a href="<?php echo e(url('/petunjuk')); ?>">Petunjuk Pembayaran</a></li>
                        <li><a href="<?php echo e(url('/faq')); ?>">FAQ</a></li>
                        <li><a href="<?php echo e(url('https://linuxsupports.com')); ?>">Official Company</a></li>
                        <li><a href="<?php echo e(url('https://blog.cilsy.id')); ?>">Blog</a></li>
                        <li><a href="<?php echo e(url('https://devops.cilsy.id')); ?>">Sekolah DevOps Cilsy</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
                    <p class="copyrigth-text">
...
<script>
 ...
 <script type="text/javascript">
    ...
    $('.dropdown-item').change(function() {
            ...
            // var url = '<?php echo e(url('category')); ?>' + '/' + $(this).val();
...
(function(){
  ...
  $("#cart").on("click", function() {
    ...
    $(function() {
      ...
      $(".keyword").autocomplete({
        source: function(request, response) {
          $.ajax({
              url: "<?php echo e(url('search/autocomplete')); ?>",
              type: "GET",
              dataType: "json",
    ...
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/bootstrap.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/pace.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/timeline.min.js')); ?>"></script>
    ...
    <!-- rating -->
    <script src="<?php echo e(asset('template/web/js/star-rating.min.js')); ?>"></script>
    <!-- rating -->
    <!-- Custom Js -->
    <script>
      var TOKEN = '<?php echo e(csrf_token()); ?>';
      var MEMBER = <?php echo e(Auth::guard('members')->user()->id ?? 'null'); ?>;
    ...
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/custom.js?'.$mtime)); ?>"></script>
