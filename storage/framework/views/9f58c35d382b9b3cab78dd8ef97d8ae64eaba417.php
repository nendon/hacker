        ...
        <!-- Tab Course Lampiran -->
            <div class="tab-pane fade active in" id="pills-lampiran" role="tabpanel" aria-labelledby="pills-lampiran-tab">
              ...
              <div class="box mt-4" id="rowLampiran">
                ...
                <div class="row p-4">
                  <button class="btn btn-green pull-right" onclick="saveLampiran(<?php echo e($bootcamp->id); ?>)">+ Simpan</button> 
              ...
              <div class="box my-4">
                <div class="row">
                  <div class="col-xs-12">
                    <i class="fa fa-download"></i> <?php echo e($file->nama); ?>

                    <a class="pull-right collapsed" id="collapse" data-toggle="collapse" href="#collapseLampiran<?php echo e($file->id); ?>" role="button"></a>
                  </div>
                </div>
                <div class="collapse" id="collapseLampiran<?php echo e($file->id); ?>">
                  <div class="box bg-grey mt-4">
                    <h5>Edit Lampiran</h5>
                    <input type="hidden" name="lamp_id" value="<?php echo e($file->id); ?>">
                    <input type="hidden" name="boot_id" value="<?php echo e($bootcamp->id); ?>">
                    <div class="form-group">
                      Judul
                      <input class="form-control bg-grey" type="text" name="nama" id="namaold<?php echo e($file->id); ?>" value="<?php echo e($file->nama); ?>" >
                    </div>
                    <div class="form-group">
                      Deskripsi
                      <input class="form-control bg-grey" type="text" name="deskr" id="deskrold<?php echo e($file->id); ?>" value="<?php echo e($file->deskripsi); ?>" >
                    </div>
                    <div class="form-group">
                      File
                      <input class="form-control bg-grey dropify" data-default-file="<?php echo e(asset($file->file)); ?>" type="file" name="file" id="fileold<?php echo e($file->id); ?>" value="<?php echo e($file->file); ?>">
                    </div>
                  </div>
                  <div class="row p-4">
                    <button class="btn pull-right"><i class="fa fa-ellipsis-v"></i></button>
                    <button class="btn btn-green pull-right  mx-2" onclick="updateLampiran(<?php echo e($file->id); ?>, <?php echo e($bootcamp->id); ?>)">+ Simpan</button> 
  ...
  <script>
      ...
      function saveLampiran(bootcamp_id) {
        ...
        if (dataform == '') {
          ...
          $.ajax({
              type    :"POST",
              url     :'<?php echo e(url("contributor/bootcamp/saveLampiran")); ?>',
              data    : dataform,
              dataType : 'json',
              contentType: false,
              processData: false,
              ...
              success:function(data){
                if (data.success == false) {
                  ...
                  function(){ 
                    location.reload("<?php echo e(url("contributor/bootcamp/$bootcamp->slug#pills-lampiran")); ?>");
                  }
                  );
                }
              }
...
function updateLampiran(lamp_id, bootcamp_id) {
       var nama = $('#namaold'+lamp_id).val();
        ...
        $.ajax({
            type    :"POST",
            url     :'<?php echo e(url("contributor/bootcamp/updateLampiran")); ?>',
            data    : dataform,
            dataType : 'json',
            contentType: false,
            processData: false,
