...
<div class="container section-content">
    <div class="row">
      <div class="col-md-3 pt-25 ">
        ...
        <?php else: ?>
          <img src="<?php echo e(asset($contri->slug)); ?>" alt="" class="img-responsive img-center">
        <?php endif; ?>
      ...
      <div class="col-sm-9" style="margin-top: 20px;">
          ...
          <?php
           if(!count($contributors_lessons) == 0) {
                foreach ($contributors_lessons as $key => $last): ?>  
                  <div class="col-md-3">
                    <div class="card">
                      <a href="<?php echo e(url('lessons/'.$last->slug)); ?>">
                          <?php if (!empty($last->image)) {?>
                            <div class="card-img" style="background-image: url('<?php echo e(asset($last->image)); ?>');"></div>
                          <?php } else {?>
                            <div class="card-img" style="background-image: url('<?php echo e(asset('template/web/img/no-image-available.png')); ?>');"></div>
                          <?php }?>
                          <div class="card-body">
                            <p><?php echo e($last->title); ?></p>
                          </div>
                          <div class="footer">
          ...
          <div class="col-md-12 text-center">
              <?php echo e($contributors_lessons->links()); ?>
