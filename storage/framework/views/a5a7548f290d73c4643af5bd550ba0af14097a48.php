                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4 col-xs-7">
                        <input class="form-control" type="text" name="harga" id="harga" placeholder="<?php echo e($bootcamp->price); ?>">
                      </div>
                    </div>

                    <button class="btn btn-green pull-right mt-4" onclick="saveHarga(<?php echo e($bootcamp->id); ?>)">Set Harga</button>
                  </div>
                </div>
              </div>
            </div>
   ...
   <script  >
     function saveHarga(bootcamp_id) {
      ...
      if (harga == '') {
        ...
        $.ajax({
            type    :"POST",
            url     :'<?php echo e(url("contributor/bootcamp/saveHarga")); ?>',
            data    : dataform,
            dataType : 'json',
            contentType: false,
            processData: false,
