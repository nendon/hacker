  ...
  <div class="col-md-12">
    ...
    <ul  class="nav nav-pills">
      <li  class="active">
        ...
        <li ><a href="<?php echo e(url('contributor/notif/read')); ?>" >Read</a>
        </li>
              ...
              <tr>
                ...
                <td>
                  <?php if($dat->category=='Komentar'): ?>
                   <a href="<?php echo e(url('contributor/comments/detail/'.$dat->slug)); ?>" onclick="readnotif(<?php echo e($dat->id); ?>)" class="btn blue">Lihat</a>
                  <?php elseif($dat->category=='point'): ?>
                   <a href="<?php echo e(url('contributor/dashboard')); ?>" onclick="readnotif(<?php echo e($dat->id); ?>)" class="btn blue">Lihat</a>
