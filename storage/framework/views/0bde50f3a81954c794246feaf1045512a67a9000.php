...
<link href="<?php echo e(asset('template/web/css/videojs-playlist-ui.vertical.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('template/web/css/videojs-errors.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('template/web/css/videojs-brand.css')); ?>" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="row pt-25 pb-15"> 
          <div class="col-xs-12 col-md-10">
            <p class="lesson-title"><?php echo e($lessons->title); ?></p>
            <p><img src="<?php echo e(asset('template/web/img/video.png')); ?>" alt="" style="height:25px; width:25px;"> <b><?php echo e(count($main_videos)); ?></b> Video</p>
          </div>
          <div class="col-xs-12 col-md-2">
          <ul style="right">
          <?php if($tutor == null): ?>
              <?php if(count($invo) != 0): ?>
                <?php if($invo->status == '2'): ?>
                <div class="lesson-video-count">Rp<?php echo e(number_format($lessons->price, 0, ",", ".")); ?></div>
                ...
                <?php else: ?>
                <div class="lesson-video-count">Rp<?php echo e(number_format($lessons->price, 0, ",", ".")); ?></div>
                <button type="button" class="lesson-video-count" onclick="addToCart(<?php echo e($lessons->id); ?>)"><i class="fa fa-shopping-cart"></i> Beli</button>
                <?php endif; ?>
              <?php else: ?>
              <div class="lesson-video-count">Rp<?php echo e(number_format($lessons->price, 0, ",", ".")); ?></div>
              <button type="button" class="lesson-video-count" onclick="addToCart(<?php echo e($lessons->id); ?>)"><i class="fa fa-shopping-cart"></i> Beli</button>
              ...
              <div class="video-wrapper">
                  <video id="video" class="video-js vjs-default-skin vjs-big-play-centered" height="500" width="70%">
                      <?php if(count($last_videos) > 0): ?> 
                          <source src="<?php echo e(!empty($last_videos->video) ? $last_videos->video : ''); ?>" type="<?php echo e((!empty($last_videos->type_video)) ? $last_videos->type_video : ''); ?>">
                      <?php endif; ?> 
                    </video>
              </div>
              ...
              <div class="tab-content" style="margin-top:0px;">
                ...
                <div id="tab2" class="tab-pane fade">
                  ...
                  <ul class="materi_list">
                    ...
                    <table> 
                        <tr>
                          <td><strong><?php echo $number ?> <?php echo e($row->title); ?></strong>
                  ...
                  <?php else: ?>
                    ...
                    <div class="comments-form mb-25">
                     <form id="form-comment" class="mb-25" enctype="multipart/form-data" method="POST">
                        ...
                        <input type="hidden" name="lesson_id" value="<?php echo e($lessons->id); ?>">
                      ...
                      <button type="button" class="btn btn-primary upload-image" onclick="doComment(<?php echo e($lessons->id); ?>, 0)">Tambah Pertanyaan</button> 
...
<script src="<?php echo e(asset('template/web/js/video.js')); ?>"></script>
<script src="<?php echo e(asset('template/web/js/videojs-playlist.js')); ?>"></script>
<script src="<?php echo e(asset('template/web/js/videojs-playlist-ui.js')); ?>"></script>
<script src="<?php echo e(asset('template/web/js/videojs-errors.js')); ?>"></script>
<script src="<?php echo e(asset('template/web/js/videojs-brand.min.js')); ?>"></script>
<script type="text/javascript" src="https://unpkg.com/sweetalert2@7.9.2/dist/sweetalert2.all.js"></script>
<script src="<?php echo e(asset('template/web/js/component.js')); ?>"></script>
<script src="<?php echo e(asset('template/web/js/control-bar/control-bar.js')); ?>"></script>
<script>
  $(function () {
...
function getPlayList() {
  ...
  var lessons_id = "<?php echo e($lessons->id); ?>";
  var postData =
              {
                  "_token":"<?php echo e(csrf_token()); ?>",
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo e(url('lessons/getplaylist')); ?>",
    data: postData,
    dataType: "json",
    beforeSend: function() {
...
function videoTracking(videosrc) {
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo e(url('lessons/videoTracking')); ?>",
    data: postData,
    // dataType: "json",
    beforeSend: function() {
      $('#hasil').html('<tr><td colspan="6">Loading...</td></tr>');
...
<script type="text/javascript">
  ...
  function getComments() {
    $.ajax({
        type    :'GET',
        url     :'<?php echo e(url("lessons/coments/getComments/".$lessons->id)); ?>',
        success:function(data){
          if (data == '') {
  ...
  function doComment(lesson_id, parent_id) {
    ...
    if (body == '') {
      ...
      $.ajax({
          type    :"POST",
          url     :'<?php echo e(url("/lessons/coments/doComment")); ?>',
          data    : dataform,
          dataType : 'json',
          contentType: false,
          processData: false,
