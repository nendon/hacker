    ...
    <div class="col-sm-8 col-xs-12 mt-4">
      <div class="box">
        ...
        <div class="text-right mt-2">
          <button class="btn btn-green" onclick="saveProject(<?php echo e($user->id); ?>)"><i class="fa fa-paper-plane"></i> Kirim</button>
        </div>
...
function saveProject(project_id) {
      ...
      if (body == '') {
        ...
        $.ajax({
            type    :"POST",
            url     :'<?php echo e(url("/bootcamp/contrib/saveProject")); ?>',
            data    : dataform,
            dataType : 'json',
            contentType: false,
            processData: false,
