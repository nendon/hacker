        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="box-option text-right">
               ...
               <a href="<?php echo e(url('contributor/lessons/'.$row->id.'/edit/videos')); ?>" class="btn btn-danger">Edit</a>
               <?php endif; ?>
              <a href="<?php echo e(url('contributor/lessons/'.$row->id.'/create/videos')); ?>" class="btn btn-info">Tambah Video</a>
            </div>
          </div>
        </div>
      </div>
