...
<section class="faq mb-50 pl-15">
  <div class="container">
        ...
        <div class="panel panel-default">
          ...
          <div id="collapse1" class="panel-collapse collapse">
            <div class="panel-body">
              Harganya ada di kisaran Rp. 10.000 - Rp. 2.000.000 tergantung materi tutorial yang anda pilih. Untuk melihat materi apa saja yang terdapat di cilsy Anda dapat lihat link ini : <a href="<?php echo e(url('lessons/browse/all')); ?>" target="_blank">Browse Tutorial</a>
            </div>
          </div>
        </div>
        <!-- ./ Panel -->
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <a href="<?php echo e(url('/faq')); ?>" class="btn btn-link btn-more">Lihat semua pertanyaan <i class="ion-arrow-right-c"></i></a>
      </div>
    </div>
  </div>
</section><!-- ./END GUIDE -->
