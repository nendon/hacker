  ...
  <div class="col-md-12">
    <div id="exTab1" class="container">
      ...
      <li >
        ...
        <li><a id="#2a"  href="<?php echo e(url('/contributor/bootcamp/comments/read')); ?>" >Answared</a>
        </li>
        <li  class="active"><a id="#3a"  href="<?php echo e(url('/contributor/bootcamp/comments/all')); ?>" >All</a>
        </li>
      ...
      <div class="tab-content clearfix">
        <div class="tab-pane active" >
			...
			<?php
				$cekanswer = DB::table('comments_bootcamp')->where('desc', '<>', 1)->where('contributor_id',Auth::guard('contributors')->user()->id)->orderBy('created_at','DESC')->first();
