...
.inputfile-2:focus + label, .content .inputfile-2 + label:hover {
  ...
  <body>
    ...
    <main>
      ...
      <!-- Section Header -->
      <section class="header" style="background-image: url(<?php echo e(asset('img/bg-head.jpg')); ?>);">
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              <h6 class="mb-5">Dashboard/Track</h6>
              <h2 class="mb-4"><?php echo e($bc->title); ?></h2>
              <h6><?php echo e($bc->deskripsi); ?>

              </h6>
              <br>
              <!-- <button class="btn btn-secondarys btn-lg mb-5">Mulai belajar</button> -->
              <a href="<?php echo e(url('bootcamp/'.$bc->slug.'/courseLesson/'.$mulai->id)); ?>" class="btn btn-primary mb-4">Mulai Belajar</a>
                  ...
                  <li>           
                      ...
                      <div class="timelines-content">
                        <div class="row row-eq-height box p-0">
                          ...
                          <div class="col-sm-4 col-xs-12 p-0" style="background: url(<?php echo e(asset($courses->cover_course)); ?>);background-size:cover;min-height: 250px"></div>
                          ...
                          <div class="col-sm-8 col-xs-12">
                            ...
                            <div class="row mt-3">
                              ...
                              <div class="col-xs-5 mt-4">
                                  <div class="progress">
                                    <div class="progress-bar" role="progressbar" style="width: <?php echo e($persen); ?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                  </div>
                              </div>
