        ...
        <div class="item">
            ...
            <div class="col-md-4">
             ...
             <div class="slick">
              ...
              <p><a href="<?php echo e(url('kelas/v3/'.$last->slug)); ?>" class="btn btn-primary btn-lg pull-right" style="color :white; background-color: #3CA3E0; border-color: #3CA3E0; margin-top: 100px;">Lanjutkan Tutorial</a></p>
                </p>
            </div>
