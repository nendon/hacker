        ...
        <div class="row silabus">
          ...
          <div class="col-xs-12 text-center">
              ...
              <ul>
                ...
                <li><img src="<?php echo e(asset('template/bootcamp/asset/smallicon-Projek.svg')); ?>" alt="">5 Projek</li>
                <li><img src="<?php echo e(asset('template/bootcamp/asset/smallicon-Course.svg')); ?>" alt=""><?php echo e(count($main_course)); ?> Course</li>
                        ...
                        <div class="collapse" id="section<?php echo e($courses->id); ?>">
                          ...
                          $no = 1;
                              ...
                              <li>
                                ...
                                <img src="<?php echo e(asset('template/bootcamp/asset/Lesson.svg')); ?>" alt=""> <?php echo e(count($main_videos)); ?> Video (Total 90min), 1Projek
                                </div>
                                <?php 
                                  $no++;
                                  endforeach; 
                        ...
                        <div class="collapse" id="silabus<?php echo e($courses->id); ?>">
                          ...
                          $no = 1;
                              ...
                              <li>
                                ...
                                <img src="<?php echo e(asset('template/bootcamp/asset/Lesson.svg')); ?>" alt="">12 Video (Total 90min), 1Projek
                                </div>
                                <?php 
                                  $no++;
                                  endforeach; 
        ...
        <div class="row instruktur">
          <div class="col-xs-12 text-center">
            ...
            <div class="border-blue">
              <img src="<?php echo e(asset('template/bootcamp/img/users.png')); ?>" class="img-responsive mx-auto" alt="">
