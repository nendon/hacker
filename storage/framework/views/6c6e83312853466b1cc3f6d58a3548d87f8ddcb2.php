...
<div class="row">
  <div class="col-md-12">
    <div id="exTab1" class="container">
      ...
      <li>
          <a id="#1a" href="<?php echo e(url('/contributor/comments')); ?>" >Unanswered</a>
        </li>
        <li id="#2a" class="active"><a href="<?php echo e(url('/contributor/comments/read')); ?>" >Answared</a>
        </li>
        <li><a id="#3a" href="<?php echo e(url('/contributor/comments/all')); ?>" >All</a>
        </li>
			  ...
			  <?php if($dat->status==1): ?>
				<tr>
				  ...
				  <td>
					 ...
					 <form id="un<?php echo e($dat->id); ?>" class="" action="<?php echo e(url('contributor/comments/deletecomment/'.$dat->id)); ?>" method="post">
